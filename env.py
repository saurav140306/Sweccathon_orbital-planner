...
def _observation(scenario: Any, steps_remaining: int) -> dict[str, Any]:
    ...
    return {
        ...
        "target": {
            ...
            "argument_of_periapsis_rad": round(getattr(tg, "argument_of_periapsis_rad", 0.0) or 0.0, 4),
            "inclination_rad": round(getattr(tg, "inclination_rad", 0.0) or 0.0, 4),
            "raan_rad": round(getattr(tg, "raan_rad", 0.0) or 0.0, 4),
